...
# train = []
# f = open("C:\\Users\\dws\\Desktop\\Telegram-Bot-Bob\\output.txt","r",encoding="utf8")
# for x in f:
#     train.append(x)
...
def get_bot_response(userText):
    ...
    return (analyze(userText))
    # print (analyze(userText))


# print (get_bot_response("Father"))
while True:
    x = input("Me:")
    print("Void: " + str(get_bot_response(x)))
